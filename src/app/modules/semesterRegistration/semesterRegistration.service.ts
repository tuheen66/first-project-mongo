...
const createSemesterRegistrationIntoDB = async (
  ...
  // check if any registered semester that is already 'ONGOING' or 'UPCOMING'
  ...
  // step -1: check if the semester already exists
  ...
  // step -2: check if Semester registration already exists
...
const updateSemesterRegistrationIntoDB = async (
  ...
  // if requested semester registration already exists
  ...
  // if registered semester is ended then will not be allowed to update anything
